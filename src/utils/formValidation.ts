...
export const registerValidationSchema = z.object({
  ...
  location: z.string().min(3, "Enter your location").optional(),
...
export const addPetValidationSchema = z.object({
  ...
  healthStatus: z
    .string()
    .min(3, "Health status must be at least 3 characters long"),
  ...
  specialNeeds: z
    .string()
    .min(3, "Special needs must be at least 3 characters long"),
  temperament: z
    .string()
    .min(3, "Temperament must be at least 3 characters long"),
  medicalHistory: z
    .string()
    .min(10, "Medical history must be at least 10 characters long"),
  description: z
    .string()
    .min(10, "Description must be at least 10 characters long"),
  adoptionRequirements: z
    .string()
    .min(10, "Adoption requirements must be at least 10 characters long"),
});
